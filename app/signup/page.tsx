        ...
        <div className="bg-neutral-800 md:p-5 p-2 rounded-md min-h-full min-w-96 flex flex-col justify-center items-center gap-5 border border-solid border-neutral-700">
          ...
          <div className='min-w-full'>
            <Flex direction="column" gap="5">
              ...
              <Button variant="solid" onClick={handleSubmit} loading={isSubitting}>SignUp</Button>
              <div className="w-full flex justify-center cursor-pointer">
                <Text color="blue" className={`${montserrat.className} text-sm `}>Already have an account? Try SignIn</Text>
              </div>
            </Flex>
          </div>
        </div>
